...
import (
	...
	"github.com/JerryZhou343/cctool/go/internal/conf"
	"github.com/JerryZhou343/cctool/go/internal/convert"
	"github.com/JerryZhou343/cctool/go/internal/flags"
	"github.com/JerryZhou343/cctool/go/internal/merge"
	"github.com/JerryZhou343/cctool/go/internal/srt"
	"github.com/JerryZhou343/cctool/go/internal/status"
	"github.com/JerryZhou343/cctool/go/internal/store/aliyun"
	goss "github.com/JerryZhou343/cctool/go/internal/store/google"
	aliSpeech "github.com/JerryZhou343/cctool/go/internal/text/aliyun"
	gspeech "github.com/JerryZhou343/cctool/go/internal/text/google"
	"github.com/JerryZhou343/cctool/go/internal/translate/baidu"
	"github.com/JerryZhou343/cctool/go/internal/translate/google"
	"github.com/JerryZhou343/cctool/go/internal/translate/tencent"
		...
		if _, ok := a.generatorSet[itr]; !ok {
			...
			case "google":
				...
				a.generatorSet[itr] = NewSrtGenerator(itr,
					...
					gspeech.NewSpeech(conf.G_Config.Google.CredentialsFile, conf.G_Config.SampleRate))
			case "aliyun":
